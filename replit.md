...
*   **Resend**: Transactional email service (Dec 18, 2024). Domain: `akorfa.publicvm.com`. Configured via `RESEND_API_KEY` secret. Used for sending verification emails, password resets, and notifications with excellent deliverability. See `RESEND_SETUP.md` for configuration details.
