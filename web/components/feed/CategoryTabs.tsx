        ...
        {isVisible && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              >
                <Search className="w-5 h-5 text-white" style={{filter: 'drop-shadow(0 2px 12px rgba(0, 0, 0, 0.8)) drop-shadow(-2px -2px 8px rgba(0, 0, 0, 0.7)) drop-shadow(inset 0 1px 3px rgba(0, 0, 0, 0.8))'}} />
              </Link>
                ...
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <span 
                      ...
                      style={{ fontStretch: 'condensed', filter: 'drop-shadow(0 2px 12px rgba(0, 0, 0, 0.8)) drop-shadow(-2px -2px 8px rgba(0, 0, 0, 0.7)) drop-shadow(inset 0 1px 3px rgba(0, 0, 0, 0.8))' }}
                    >
                      {category.label}
                    </span>
                  </button>
              ...
              <div className="flex-shrink-0 relative">
                ...
                >
                  <Bell className="w-5 h-5 text-white" style={{filter: 'drop-shadow(0 2px 12px rgba(0, 0, 0, 0.8)) drop-shadow(-2px -2px 8px rgba(0, 0, 0, 0.7)) drop-shadow(inset 0 1px 3px rgba(0, 0, 0, 0.8))'}} />
                </Link>
