  ...
  return (
    <div className="fixed top-3 right-3 z-50 flex flex-col items-end gap-1.5">
      {!isDiscoverPage && (
        ...
        >
          <Search className="w-5 h-5 text-white" strokeWidth={2.5} style={{filter: 'drop-shadow(0 2px 12px rgba(0, 0, 0, 0.8)) drop-shadow(-2px -2px 8px rgba(0, 0, 0, 0.7)) drop-shadow(inset 0 1px 3px rgba(0, 0, 0, 0.8))'}} />
        </Link>
      )}
      ...
      {!isNotificationPage && (
        ...
        >
          <Bell className="w-5 h-5 text-white" strokeWidth={2.5} style={{filter: 'drop-shadow(0 2px 12px rgba(0, 0, 0, 0.8)) drop-shadow(-2px -2px 8px rgba(0, 0, 0, 0.7)) drop-shadow(inset 0 1px 3px rgba(0, 0, 0, 0.8))'}} />
          {unreadCount > 0 && (
      ...
      {userId && (
        <div className="relative">
          ...
          >
            <Star className="w-5 h-5 text-white" strokeWidth={2.5} style={{filter: 'drop-shadow(0 2px 12px rgba(0, 0, 0, 0.8)) drop-shadow(-2px -2px 8px rgba(0, 0, 0, 0.7)) drop-shadow(inset 0 1px 3px rgba(0, 0, 0, 0.8))'}} />
            {streak > 0 && (
