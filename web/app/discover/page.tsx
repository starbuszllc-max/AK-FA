      ...
      <div className="flex-shrink-0 px-3 pt-3 pb-2 space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-4 space-y-4">
        ...
        <div className="">
          <div className="flex items-center justify-between py-2">
            ...
            <Link href="/communities" className="text-xs text-green-600 dark:text-green-400 hover:underline">
              View All
            </Link>
          </div>
            ...
            {filteredBoards.slice(0, 6).map((board) => (
              ...
              >
                <div className="flex items-start gap-2.5 py-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    {board.name.charAt(0)}
                  </div>
                  <div className="flex-1 min-w-0">
