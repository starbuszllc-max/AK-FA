...
export default function CoachPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-3 safe-area-top pt-4">
      <div>
        <div className="bg-gradient-to-r from-green-600 to-purple-600 px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-green-100 text-xs">Personal growth guide</p>
              </div>
            </div>
            ...
            <div className="flex bg-white/20 rounded-md p-0.5">
              <button
                ...
                className={`px-2 py-1 rounded text-xs font-medium flex items-center gap-1 transition-all ${
                  mode === 'text' ? 'bg-white text-green-600' : 'text-white hover:bg-white/10'
                }`}
              >
              ...
              <button
                ...
                className={`px-2 py-1 rounded text-xs font-medium flex items-center gap-1 transition-all ${
                  mode === 'voice' ? 'bg-white text-green-600' : 'text-white hover:bg-white/10'
                }`}
              >
