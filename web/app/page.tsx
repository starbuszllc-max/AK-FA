...
export default function Home() {
  ...
  return (
    <main className="-mt-6 -mx-6">
      <section className="bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 dark:from-indigo-800 dark:via-purple-800 dark:to-indigo-900 text-white py-20 px-6">
      ...
      <section className="py-16 px-6 bg-white dark:bg-slate-900">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4 text-gray-900 dark:text-white">The 7 Layers of Being</h2>
      ...
      <section className="py-16 px-6 bg-gray-50 dark:bg-slate-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">How Akorfa Works</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-white dark:bg-slate-700 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-slate-600 hover:shadow-md transition-shadow"
              >
      ...
      <section className="py-16 px-6 bg-white dark:bg-slate-900">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4 text-gray-900 dark:text-white">Stability Formula</h2>
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 p-8 rounded-2xl text-center">
            <div className="font-mono text-2xl md:text-3xl text-indigo-700 dark:text-indigo-300 mb-4">
              S = R × (L + G) / (|L - G| + C - (A × n))
            </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-indigo-600 to-purple-600 dark:from-indigo-800 dark:to-purple-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
      ...
      <footer className="bg-gray-900 dark:bg-black text-gray-400 py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="font-bold text-white text-xl">Akorfa</span>
          </div>
